...
import 'package:t2_2021110055/screens/feedback_screen.dart';
import 'package:t2_2021110055/screens/welcome_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Widget> _widgetOptions = [
    const HomeWidget(welcomeMessage: 'Temukan Berbagai Macam Sayuran'),
    const StoreWidget(),
    const CartWidget(),
  ];
